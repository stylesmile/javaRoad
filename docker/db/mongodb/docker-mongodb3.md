...
docker run -v /root/mongo-back:/root/mongo-back -d -p 27018:27017 --name mongo  mongo:3.4 --auth
docker run -v /root/mongo-back:/root/mongo-back -d -p 27017:27017 --name mongo36  mongo:3.6 --auth
docker run -v /root/mongo-back:/root/mongo-back -d -p 27018:27017 --name mongo34  mongo:3.4 --auth

docker update --restart=always mongo36
docker update --restart=on-failure:3 mongo36
...
#管理员方式进入容器
docker exec -it mongo36 mongo admin
