...
```
```
sudo docker run -d -p 7088:7088 --restart=always -v /home/ubuntu/java/jenkins:/jenkins --name jenkins2 ibm-semeru-runtimes:open-17-jdk-jammy java -jar /jenkins/jenkins2.462.2.war --httpPort=7088
```
